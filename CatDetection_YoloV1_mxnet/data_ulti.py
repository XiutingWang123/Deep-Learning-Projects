...
if __name__ == "__main__":
    ...
    imglist_val = annotation.keys()[:50]
    imglist_train = annotation.keys()[51:]
    sizet = 224
    toRecFile(imgroot, imglist_val, annotation, sizet, (7,7,5), 32, "cat_val")
    toRecFile(imgroot, imglist_train, annotation, sizet, (7, 7, 5), 32, "cat_train")