...
def conv_layer(input_layer, n_ker, n_filter, pool=False):
    """
    ...
    l = mx.sym.Convolution(data=input_layer, kernel=(n_ker, n_ker), num_filter=n_filter)
...
def get_conv_sym():
    ...
    l = conv_layer(input_layer=data, n_ker=5, n_filter=32, pool=False)
    l = conv_layer(input_layer=l, n_ker=5, n_filter=32, pool=True)
    l = conv_layer(input_layer=l, n_ker=5, n_filter=128, pool=False)
    l = conv_layer(input_layer=l, n_ker=5, n_filter=128, pool=True)
